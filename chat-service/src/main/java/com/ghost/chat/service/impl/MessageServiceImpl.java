package com.ghost.chat.service.impl;
...
public class MessageServiceImpl implements MessageService {
    ...
    public MessageServiceImpl(DiscoveryClient client, @Qualifier("eurekaRegistration") Registration registration) {
        this.client = client;
    ...
    public String sendMessage(String text) {
        ...
        log.info("调用发送消息接口:" + json.toJSONString());
